...
export const Items = [
  ...
  { id: uuidv4(), name: "Leather Boots",      type: "boots",        imageUrl: getItemName("Leather Boots")},
  { id: uuidv4(), name: "Leather Legs",       type: "legs",        imageUrl: getItemName("Leather Legs")},
  { id: uuidv4(), name: "Backpack",           type: "bag",        imageUrl: getItemName("Backpack")},
  { id: uuidv4(), name: "Platinum Amulet",           type: "necklace",        imageUrl: getItemName("Platinum Amulet")},
]
...
export const MySlots = () => {
    const list = [
      ...
      { id: uuidv4(), type: "ring",        item: null,                         imageUrl: "Images/InventorySlots/ring.png" },
      { id: uuidv4(), type: "ring",        item: null,                         imageUrl: "Images/InventorySlots/ring.png" },
      { id: uuidv4(), type: "ring",        item: null,                         imageUrl: "Images/InventorySlots/ring.png" },
      { id: uuidv4(), type: "ring",        item: null,                         imageUrl: "Images/InventorySlots/ring.png" },
      { id: uuidv4(), type: "ring",        item: create(Items[3]),             imageUrl: "Images/InventorySlots/ring.png" },
...
export function InventoryProvider({ children }) {
  ...
  function addItem(itemAdded){
    const item = create(itemAdded)
    const tempSlots = [...slots];
    const nullSlotIndex = tempSlots.findIndex(slot => slot.item === null && slot.type === "backpack");

    if (nullSlotIndex !== -1) {
      tempSlots[nullSlotIndex].item = item;
    }
  ...
  return (
      <InventoryContext.Provider value={{ slots, moveItemFromTo, doubleClick, isItemEquipped, getSlotInformation, addItem}}>
          {children}
